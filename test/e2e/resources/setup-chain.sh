...
from_scratch () {
    ...
    #'.app_state["storage"]["params"]["check_window"]="'10'"'
    ...
    canined add-genesis-account $KEY 100000000000000ujkl --keyring-backend $KEYRING
    canined add-genesis-account $DEPOACCKEY 1000000000000ujkl  --keyring-backend $KEYRING
    canined add-genesis-account $KEY1 1000000000000ujkl  --keyring-backend $KEYRING
    canined add-genesis-account $KEY2 1000000000000ujkl  --keyring-backend $KEYRING
...
fix_config() {
    ...
    sed -i.bak -e 's/address = "0.0.0.0:9090"/address = "0.0.0.0:9090"/' $HOME/.canine/config/app.toml

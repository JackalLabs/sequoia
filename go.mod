...
require (
	github.com/JackalLabs/jackal-provider v1.2.0
...
require (
	...
	github.com/jackalLabs/canine-chain/v3 v3.2.2 // indirect
...
replace (
	...
	github.com/JackalLabs/jackal-provider => github.com/JackalLabs/canine-provider v1.2.0

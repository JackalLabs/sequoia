...
replace (
	...
	github.com/jackalLabs/canine-chain/v3 => github.com/jackalLabs/canine-chain/v3 v3.0.2-0.20231110152021-8f211f3441f9 // using the master branch for now before v4 releases

...
replace (
	...
	github.com/jackalLabs/canine-chain/v3 => github.com/jackalLabs/canine-chain/v3 v3.0.2-0.20231108190624-6bdaffb001d5 // using the master branch for now before v4 releases
